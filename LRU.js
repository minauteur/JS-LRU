...
*/
const memoizedAddXY = memoizedLRU(function (x, y) { return addXY(x, y) });
const memoizedAddN = memoizedLRU(function () { return addN(...Array.from(arguments)) });
/*
...
console.log("...should call memoizedAddXY(1, 2), write 3 to the cache and then return it: " + memoizedAddXY(1, 2));
console.log("...should return 3 from cache directly: " + memoizedAddXY(1, 2));
console.log("calling memoizedAddN(1,2,3) twice...");
console.log("...should call memoizedAddN(1, 2, 3), write 6 to the cache and then return it: " + memoizedAddN(1, 2, 3));
